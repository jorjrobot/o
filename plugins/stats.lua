...
local function run(msg, matches)
  if matches[1]:lower() == 'رادیکال' then -- Put everything you like :)
    ...
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /رادیکال ")
    return about
  end 
  ...
  if matches[1]:lower() == "امار" then
    ...
    if matches[2] == "رادیکال" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^(لیست امار)$",
    "^([آا]مار) (گروه) (%d+)",
    "^([آا]مار) (رادیکال)",-- Put everything you like :)
		"^(رایدکال)"-- Put everything you like :)
    }, 
  run = run
}
